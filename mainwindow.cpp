    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(this->bluetooth_communicator, SIGNAL(parsedTelemetry(Telemetry)), this->joystick_steering_window, SLOT(parsedTelemetry(Telemetry)));
    ...
    connect(this->ui->pushButtonAngCorr, SIGNAL(clicked()), this->bluetooth_communicator, SLOT(toggleAngleCorrection()));
}
