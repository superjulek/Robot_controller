    ...
    ui(new Ui::ManualSteeringWindow)
{
    ...
    ui->plotAngle->graph(0)->setName("kąt");
    ui->plotAngle->addGraph();
    ui->plotAngle->graph(1)->setPen(QPen(Qt::red));
    ui->plotAngle->graph(1)->setName("zadany kąt");
    ...
    ui->plotSpeed->graph(0)->setName("prędkość");
    ui->plotSpeed->addGraph();
    ui->plotSpeed->graph(1)->setPen(QPen(Qt::red));
    ui->plotSpeed->graph(1)->setName("zadana prędkość");
